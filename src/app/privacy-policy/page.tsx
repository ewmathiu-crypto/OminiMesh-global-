  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <p className="mt-10 text-sm leading-7 text-slate-500">For questions about this policy, please visit our <Link href="/contact" className="text-cyan-300 underline">Contact</Link> page.</p>
        <p className="mt-2 text-sm leading-7 text-slate-500">This policy may be updated periodically. Please review it from time to time.</p>
      </section>
    </main>
  );
}
