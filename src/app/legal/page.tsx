      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <Link href="/privacy-policy" className="block rounded-3xl border border-white/10 bg-white/[0.04] p-6 transition hover:border-cyan-300/40">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-300">How we collect, use, and protect your personal data across our platform and services.</p>
          </Link>
          <Link href="/contact" className="block rounded-3xl border border-white/10 bg-white/[0.04] p-6 transition hover:border-cyan-300/40">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-300">Reach our legal and support teams for inquiries, complaints, or partnership matters.</p>
          </Link>
        </div>
