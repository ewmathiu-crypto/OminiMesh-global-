      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-slate-400">To deliver one intelligent, global internet that adapts to every user, device, and location — removing barriers and unlocking opportunity worldwide.</p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
            <h3 className="text-lg font-semibold text-white">Our Vision</h3>
            <p className="mt-3 text-sm leading-7 text-slate-400">A world where connectivity is no longer limited by borders, carriers, or geography — where AI continuously optimizes the best path for every connection.</p>
          </div>
        </div>
        <div className="mt-10">
          <a
