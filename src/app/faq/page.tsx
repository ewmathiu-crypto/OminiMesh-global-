...
const faqs = [
  ...
  },
  {
    ...
    a: "You can reach support through our <Link href='/contact' className='text-cyan-300 underline'>Contact</Link> page. Partners and enterprise customers receive priority support.",
  },
];
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        ...
        <p className="mt-10 text-base leading-7 text-slate-500">Still have questions? <Link href="/contact" className="text-cyan-300 underline">Contact us</Link>.</p>
      </section>
    </main>
  );
}
